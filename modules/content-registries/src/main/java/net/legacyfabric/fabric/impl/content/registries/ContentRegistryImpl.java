...
package net.legacyfabric.fabric.impl.content.registries;
...
import net.legacyfabric.fabric.api.event.registry.v1.FabricRegistryEntryAddedEvents;
import net.legacyfabric.fabric.mixin.content.registries.MutableRegistryAccessor;
import net.legacyfabric.fabric.mixin.content.registries.BlockAccessor;
import net.legacyfabric.fabric.mixin.content.registries.BlockEntityAccessor;
import net.legacyfabric.fabric.mixin.content.registries.EntityTypeAccessor;
import net.legacyfabric.fabric.mixin.content.registries.SimpleRegistryAccessor;
