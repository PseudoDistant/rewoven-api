...
import net.legacyfabric.fabric.api.event.registry.v1.RegistryBlockAddedCallback;
import net.legacyfabric.fabric.api.event.registry.v1.RegistryBlockEntityAddedCallback;
import net.legacyfabric.fabric.api.event.registry.v1.RegistryEntityAddedCallback;
import net.legacyfabric.fabric.api.event.registry.v1.RegistryItemAddedCallback;
